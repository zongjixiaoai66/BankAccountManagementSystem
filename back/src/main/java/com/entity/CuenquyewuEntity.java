...
public class CuenquyewuEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public CuenquyewuEntity() {

	}

	public CuenquyewuEntity(T t) {
		try {
    ...
    public String toString() {
        return "Cuenquyewu{" +
            ...
            ", kaihuId=" + kaihuId +
            ", yonghuId=" + yonghuId +
            ", cuenquyewuPrice=" + cuenquyewuPrice +
            ", cuenquyewuTypes=" + cuenquyewuTypes +
